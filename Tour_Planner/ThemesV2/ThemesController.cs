...
namespace Tour_Planner {
    public static class ThemesController {
        ...
        public static void SetTheme(ThemeType theme) {
            ...
            ThemeDictionary = new ResourceDictionary() { Source = new Uri($"ThemesV2/{themeName}.xaml", UriKind.Relative) };
            ControlColours = new ResourceDictionary() { Source = new Uri("ThemesV2/ControlColours.xaml", UriKind.Relative) };
            Controls = new ResourceDictionary() { Source = new Uri("ThemesV2/Controls.xaml", UriKind.Relative) };
        }
